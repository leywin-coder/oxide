...
export function createFsTools(fs, options) {
...
async function walkDir(fs, root, dir) {
...
function takeItemsWithinByteLimit(items, maxBytes) {
    let totalBytes = 0;
    const limitedItems = [];
...
//# sourceMappingURL=create-fs-tools.js.map